...
class QtCGI : public QObject
{
	...
	protected:
         ...
         * @brief QtCGI::mPostStrParameters
         * @var QString
         */
        QString mPostStrParameters;
	...
	public:
        ...
        /**
         * @paragraph This method returns the current request method from the instance
         * @brief QtCGI::GetRequestMethod()
         * @return QString QtCGI::mRequestHeaders.value(QtCGI::HeaderRequestMethod).toUpper()
         */
        QString GetRequestMethod();
